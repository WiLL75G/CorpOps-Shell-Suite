...
**A production-grade SOC analyst home lab portfolio built around a fictional corporate environment Nexus Corp.**

Each project executes a complete Tier 1 incident response workflow: baseline → attack simulation → detection → response → verification. Every project produces a structured incident report README, a detection or analysis script, full evidence artifacts, and MITRE ATT&CK mapping.
